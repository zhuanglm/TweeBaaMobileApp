...
ForgotpassLayer::ForgotpassLayer(){};

ForgotpassLayer::~ForgotpassLayer(){};


Scene* ForgotpassLayer::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = ForgotpassLayer::create();
...
void ForgotpassLayer::menuCallback(Ref *sender) {
...
bool ForgotpassLayer::init(){
	...
	float generalscalefactor  = visiableSize.height / 500 ;
		...
		auto menuItem_7  = MenuItemSprite::create(game7,game7_a,NULL,CC_CALLBACK_1(ForgotpassLayer::menuCallback, this));
	...
	//Size winSize = Director::getInstance()->getVisibleSize();
		...
		webView->loadURL("https://tweebaa.com/User/resetpwd.aspx");
		...
		uButtonA->addTouchEventListener(this, ::ui::SEL_TouchEvent(&ForgotpassLayer::touchButton));
...
void ForgotpassLayer::touchButton(Object* obj,::ui::Widget::TouchEventType eventType)  
{  
...
void ForgotpassLayer::scrollLand(float dt){
	/*
